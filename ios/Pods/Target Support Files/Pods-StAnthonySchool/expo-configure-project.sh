...
with_node \
  ...
  --target "/Users/muhammedshuraim/Documents/personal/school-management-clean/ios/Pods/Target Support Files/Pods-StAnthonySchool/ExpoModulesProvider.swift" \
  --entitlement "/Users/muhammedshuraim/Documents/personal/school-management-clean/ios/StAnthonySchool/StAnthonySchool.entitlements" \
  --platform "apple" \
  --packages "expo" "expo-application" "expo-asset" "expo-constants" "expo-device" "expo-document-picker" "expo-eas-client" "expo-file-system" "expo-font" "expo-image-picker" "expo-keep-awake" "expo-media-library" "expo-notifications" "expo-updates"
